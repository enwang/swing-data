...
class SwingDataStaticTests(unittest.TestCase):
    ...
    def test_visible_right_edge_replay_anchor_is_desktop_only(self):
        ...
        self.assertIn("is_visible_replay_fallback = timeframe.isintraday and is_right_visible_bar and not found_complete_visible_rth_day", desktop)
        self.assertIn("is_data_anchor_bar = use_visible_replay ? (timeframe.isintraday ? (is_complete_visible_rth_day or is_visible_replay_fallback) : is_right_visible_bar) : barstate.islast", desktop)
